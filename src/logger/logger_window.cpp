...
LoggerWindow::LoggerWindow(wxWindow* parent)
    ...
    , _loggerController(new LoggerController(new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE | wxTE_READONLY), "log.txt"))
{
